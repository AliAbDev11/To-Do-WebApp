...
urlpatterns = [
    ...
    path('tasklist/<int:tasklist_id>/update/', views.update_tasklist, name='update_tasklist'),
    path('tasklist/<int:tasklist_id>/delete/', views.delete_tasklist, name='delete_tasklist'),
]